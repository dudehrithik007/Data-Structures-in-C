...
void main()
{
    printf("\nProgram to input two matrices in the sparse format, store them, and find and store the multiplication of the sparse matrices entered, display it, and store and display the multiplication in the usual format.\n\n");
